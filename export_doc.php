...
$sql = "SELECT * FROM liquidacion where id='".$numLiquidacion."'";
...
<form name="form1" method="post" action="">
  ...
  <table width="91%">
    <tbody>
      <tr>
        <td align="center"><h3 style="color:#A0A0FF;">Informe de Liquidacion
          <?=date("d/m/Y"); ?>
        </h3></td>
      </tr>
    </tbody>
          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="90%"><?php
			  // Tiene que agregar tantan salidas de carpetas en la ruta de la imagen hasta lograr ubucar la misma profundidad de la carpeta "Soft"
			  // las salidas de carpetas se agregan con "../" para salir de la carpeta actual
			  // ../../ para salir de dos carpetas anidadas
			  // ../../../ para salir de 3 carpetas anidadas
              ...
              <tr>
                <td><strong>83 Imagen 6:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes6 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 6:</strong></td>
                <td><?php echo $texto6;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>84 Imagen 7:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes7 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 7:</strong></td>
                <td><?php echo $texto7;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>85  Imagen 8:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes8 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 8:</strong></td>
                <td><?php echo $texto8;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>86 Imagen 9:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes9 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 9:</strong></td>
                <td><?php echo $texto9;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>87 Imagen 10:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes10 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 10:</strong></td>
                <td><?php echo $texto10;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>88 Imagen 11:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes11 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 11:</strong></td>
                <td><?php echo $texto11;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>89 Imagen 12:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes12 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 12:</strong></td>
                <td><?php echo $texto12;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>90 Imagen 13:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes13 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 13:</strong></td>
                <td><?php echo $texto13;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>91 Imagen 14:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes14 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>Texto 14:</strong></td>
                <td><?php echo $texto14;?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td><strong>92 Imagen 15:</strong></td>
                <td><img src="http://artiguesliquidadores.cl/soft/_lib/file/imgfotos/<?php echo $imagenes15 ?>" width="427" height="283" alt="1"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
