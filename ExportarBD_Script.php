...
function exportarTablas($host, $usuario, $pasword, $nombreDeBaseDeDatos)
{
    ...
    # Se guardará dependiendo del directorio, en una carpeta llamada RESPALDOS_BD
    $carpeta = __DIR__ . "/RESPALDOS_BD";
    ...
    $archivo = "RESPALDOS_BD/BD_Artigues_";
    ...
    return file_put_contents($nombrearchivo, $contenido) !== false;
}
